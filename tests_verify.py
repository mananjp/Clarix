...
from app.models import Organization, ReportingProject, RegulationField, FieldAnswer, ValidationResult, User
...
def run_verifications():
    ...
    try:
        ...
        latest_ans = db.query(FieldAnswer).filter(FieldAnswer.id == answer_id).first()
        if latest_ans is None:
            raise RuntimeError("Answer was not created during verification")
